...
class StringHelpersTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test01_PartOne()
    {
        ...
        $this->assertEquals('Attributes', Lib::remove_namespace(\Nine\Collections\Attributes::class));
        $this->assertEquals('Attributes', Lib::remove_namespace(\Nine\Collections\Attributes::class, 'F9'));
    ...
    public function test06_PartSix()
    {
        ...
        $this->assertEquals('the-balls-are-bouncy-eh', Lib::string_to_uri('The balls are bouncy, eh?'));
    }
